...
namespace Contable.Application
{
    ...
    public class SectorMeetSessionAgreementAppService : ContableAppServiceBase, ISectorMeetSessionAgreementAppService
    {
        ...
        private readonly IRepository<SectorMeetSessionAgreementCompromise> _sectorMeetSessionAgreementCompromiseRepository;
        ...
        public SectorMeetSessionAgreementAppService(
            ...
            IRepository<SectorMeetSessionAgreementCompromise> sectorMeetSessionAgreementCompromiseRepository,
        ...
        [AbpAuthorize(AppPermissions.Pages_ConflictTools_SectorMeet)]
        public async Task<List<SectorMeetSessionAgreementDto>> Get(SocialConflictGetInputDto input)
        {
            var output = new List<SectorMeetSessionAgreementDto>();
            ...
            if (input.SocialConflictId.HasValue)
            {
                ...
                var dbSectorMeetSessionAgreements = (from a1 in _socialConflictRepository.GetAll()
                                                     ...
                                                     select new SectorMeetSessionAgreementDto()
                                                     {
                                                         ...
                                                         CompromiseId = (x == null ? (long)0 : x.CompromiseId),
